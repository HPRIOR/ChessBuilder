...
{
    public class QueenTurnMoves : IPieceMoveGenerator
    {
        private readonly IBoardScanner _boardScanner;
        private readonly IPositionTranslator _positionTranslator;

        public QueenTurnMoves(PieceColour pieceColour, IPositionTranslatorFactory positionTranslatorFactory,
        ...
        public class Factory : PlaceholderFactory<PieceColour, QueenTurnMoves>
        {
        }
    }
}