...
{
    public class UnrestrictedBoardScanner : IBoardScanner
    {
        private readonly IPositionTranslator _positionTranslator;
        private readonly ITileEvaluator _tileEvaluator;

        public UnrestrictedBoardScanner(
        ...
        public class Factory : PlaceholderFactory<PieceColour, UnrestrictedBoardScanner>
        {
        }
    }
}