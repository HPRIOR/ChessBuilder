...
namespace Tests.UnitTests.Game
{
    ...
    public class GameStateUpdaterTests : ZenjectUnitTestFixture
    {
        ...
        public void GameStateChange_Check_IsCorrect()
        {
            ...
            board[1][1].CurrentPiece = PieceType.BlackKing;
            board[7][7].CurrentPiece = PieceType.WhiteKing;
            board[6][4].CurrentPiece = PieceType.WhiteQueen;
        ...
        public void RevertingGameState_CorrectlyReversePossibleMoves()
        {
            var board = _boardGenerator.GenerateBoard();
            board[0][0].CurrentPiece = PieceType.WhiteKing;
            board[1][0].CurrentPiece = PieceType.WhitePawn;

            board[0][7].CurrentPiece = PieceType.BlackKing;
            board[1][7].CurrentPiece = PieceType.BlackPawn;
        ...
        public void RevertingGameState_CorrectlyReversesResolvedBuilds()
        {
            ...
            var sut = gameStateUpdater.GameState;
            Assert.That(sut.BoardState.Board[2][3].CurrentPiece, Is.EqualTo(PieceType.NullPiece));
            Assert.That(sut.BoardState.Board[3][3].CurrentPiece, Is.EqualTo(PieceType.NullPiece));
            Assert.That(sut.BoardState.Board[3][4].CurrentPiece, Is.EqualTo(PieceType.NullPiece));
            Assert.That(sut.BoardState.Board[3][5].CurrentPiece, Is.EqualTo(PieceType.NullPiece));
            Assert.That(sut.BoardState.Board[3][6].CurrentPiece, Is.EqualTo(PieceType.NullPiece));
            Assert.That(sut.BoardState.Board[3][7].CurrentPiece, Is.EqualTo(PieceType.NullPiece));
        }
        ...
        public void RevertingGameState_CorrectlyReversesBoardPieces()
        {
            ...
            Assert.That(sut[0][0].CurrentPiece, Is.EqualTo(PieceType.WhiteKing));
            Assert.That(sut[1][0].CurrentPiece, Is.EqualTo(PieceType.WhitePawn));

            Assert.That(sut[0][7].CurrentPiece, Is.EqualTo(PieceType.BlackKing));
            Assert.That(sut[1][7].CurrentPiece, Is.EqualTo(PieceType.BlackPawn));
        }
