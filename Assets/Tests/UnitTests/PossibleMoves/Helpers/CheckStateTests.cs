    ...
    public class CheckStateTests : ZenjectUnitTestFixture
    {
        ...
        public void WhenNotInCheck_PropertyIsFalse()
        {
            ...
            ICheckedState checkedState =
                new CheckedState(boardState, new BoardPosition(6, 5), PieceColour.White, _possibleMoveFactory);
        ...
        public void WhenInCheck_PropertyIsTrue()
        {
            ...
            ICheckedState checkedState =
                new CheckedState(boardState, new BoardPosition(7, 7), PieceColour.White, _possibleMoveFactory);
        ...
        public void WhenInCheck_OnlyInterceptingMovesAreGiven()
        {
            ...
            var interceptingMoves = checkedState.PossibleNonKingMovesWhenInCheck(possibleMoves);
